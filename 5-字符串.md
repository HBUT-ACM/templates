...
using namespace std;
namespace large {
	void large(string m_str1, string m_ch, string m_str2);            //两数的运算
...
void large::large(string m_str1, string m_ch, string m_str2) {//两数的运算
	int m_ilocation1 ;
	int m_ilocation2 ;
	string m_res;
	int m_istr;
	...
	if (m_ilocation1 == 0 && m_ilocation2 == 0) {
		...
		if(m_ch=="+") {
			...
			m_res = DIV_INT(m_str1, m_str2);
        } else if (m_ch=="%") m_res = MOD_INT(m_str1, m_str2);
	}
	cout << m_res << endl;
}
